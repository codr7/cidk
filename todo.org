* add calcl main/repl reg env update like cidk
* only mark regs with type != nullptr in Cx.mark()
* --
* finish for op
...
* inherit Env from List and add EnvType
** discard temporary compile envs after use in do/defun
** add env lib with Env.new fun
